...
export default function Archieve() {
  ...
  return (
    <div>
      <div className="flex justify-between px-6 items-center py-2 bg-gray-50 border-t border-b border-gray-200">
        ...
        <div>
          <p
            ...
            className="text-red-500 text-xl cursor-pointer hover:scale-102 transition"
          >
            <RiDeleteBin6Line />
          </p>
        </div>
      ...
      {visible && (
        <div className="w-full flex flex-col gap-4 px-6 pt-6 pb-10 h-[83vh] overflow-auto">
          {data.map((item: Item) => (
            <div
